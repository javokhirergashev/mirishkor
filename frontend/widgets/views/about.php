        ...
        <div class="section-content">
            <div class="row">
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="tm-element-holder border-2px mb-lg-30 p-30 border-10px">
                        <div class="tm-element-holder-wrapper">
                            <div class="tm-element-holder-content">
                                <div class="tm-sc-icon-box icon-box icon-top tm-iconbox-icontype-font-icon text-left iconbox-centered-in-responsive iconbox-theme-colored1 icon-position-icon-top">
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="tm-element-holder tm-fullwidth border-2px p-30 border-10px">
                        <div class="tm-element-holder-wrapper">
                            <div class="tm-element-holder-content">
                                <h4 class=""><?= Yii::t("app", "schedule") ?></h4>
                                <ul class="tm-sc-opening-hours tm-sc-opening-hours-compressed opening-hours border-light">
                                    <li class="clearfix">
                                        <span><?= Yii::t("app", "schedule1") ?></span>
        ...
        <div class="section-content">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-5">
                    <img src="/frontend-files/images/services/sc4.jpg" class="attachment-full mb-10" alt="images"/>
