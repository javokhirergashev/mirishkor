...
//                                'filter'=>$service_description,
                            ...
                            [
                                'attribute' => 'images',
                                'value' => function($data){
                                    $image = StaticFunctions::getImage('service',$data->id, $data->image);
                            ...
                            [
                                ...
                                'value' => function ($data) {
                                    if ($data->service_category) {
                                        return \common\models\ServiceCategory::findOne($data->service_category)->getName();
                                    }
                                }
                            ],
                            'price',
